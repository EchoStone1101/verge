...
### `impl_iterator_verge!(str_split_inclusive)`
...
### `impl_iterator_verge!(str_split_terminator)`
...
### `impl_iterator_verge!(str_splitn)`
...
### `impl_iterator_verge!(str_match_indices)`
