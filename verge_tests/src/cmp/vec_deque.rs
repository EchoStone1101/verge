...
fn test_verified_bridge_lemmas_for_vec_deque() {
    proof {
        lemma_partial_eq_verified::<VecDeque<u32>>();
        lemma_partial_ord_verified::<VecDeque<u32>>();
        lemma_ord_verified::<VecDeque<u32>>();
        broadcast use vstd::std_specs::vecdeque::group_vec_dequeue_axioms;
        broadcast use verge::cmp::vec_deque::group_vec_deque_ordering;
    }
